...
public class main {
    public static void main(String[] args) {
        Banco banco = new Banco("davivienda", "12346876");
        Cliente cliente = new Cliente("ambrosio", "jimenez", "128475134", "calle56","sdfgksjgh@xd.com");

        System.out.println("el nombre del banco es " + banco.getNombre());
        System.out.println("el codigo del banco es " + banco.getNit());
